  ...
  return (
    ...
    className="h-fit w-full flex flex-col p-4 md:p-6 justify-center items-center my-8 relative z-0" id="subscribe">
     <div className="h-full w-full absolute -z-10">
         ...
         <Card className="text-white my-6 p-6 h-full w-full md:w-1/2 bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 border-transparent animate-fadeinup-2 ">
