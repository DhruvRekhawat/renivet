...
const HowitWorks = () => {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 px-4 md:px-8 place-items-center gap-4 my-6">
      ...
      <Card className="w-full animate-fadeinup-2 h-full bg-brand-offwhite rounded-sm">
      ...
      <Card className="w-full animate-fadeinup-3 h-full bg-brand-offwhite rounded-sm">
